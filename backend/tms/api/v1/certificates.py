...
from tms.schemas import CertificateCreate, CertificateRead, TokenPayload

router = APIRouter()


@router.get("/", response_model=list[CertificateRead], dependencies=[Depends(require_ops_or_admin)])
