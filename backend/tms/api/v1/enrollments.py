...
from tms.schemas import EnrollmentCreate, EnrollmentRead, EnrollmentUpdate, TokenPayload

router = APIRouter()


@router.get("/", response_model=list[EnrollmentRead], dependencies=[Depends(require_ops_or_admin)])
